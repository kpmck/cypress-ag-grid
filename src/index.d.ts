...
declare namespace Cypress {
    interface Chainable<Subject> {
      getAgGrid(options?: {}): Chainable<Subject>;
      /**
       ...
       * @returns
       */
      agGridSortColumn(columnName: string, sortDirection: string): Chainable<Subject>;
       ...
       */
      agGridColumnFilterCheckboxMenu(options: {}): Chainable<Subject>;
       ...
       * @param options.hasApplyButton [Optional] True if "Apply" button is used, false if filters by text input automatically.
       */
      agGridColumnFilterTextMenu(options: {}): Chainable<Subject>;
       ...
       * @param options.hasApplyButton [Optional] True if "Apply" button is used, false if filters by text input automatically.
       */
      agGridColumnFilterTextFloating(options: {}): Chainable<Subject>;
       ...
       * @param {*} actualTableData The actual page data returned from the getAgGrid() command.
       ...
       * @param {*} actualTableData The actual page data returned from the getAgGrid() command.
       */
      agGridValidateEmptyTable(actualTableData: {}): Chainable<Subject>;
